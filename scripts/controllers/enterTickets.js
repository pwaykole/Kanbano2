app.controller('ticketsController',['$scope','$http','$timeout','allTickets','onlyTickets', function ($scope, $http, $timeout,allTickets,onlyTickets) {

    var forTicket = onlyTickets.data;
...
//code to verify ticket if exists
$scope.verifyTicketRef = function(){
        $scope.errorticketRef = false;
        if(forTicket[$scope.tickets.ticketRef] != undefined){
            $scope.errorticketRef = true;
        }
    }
